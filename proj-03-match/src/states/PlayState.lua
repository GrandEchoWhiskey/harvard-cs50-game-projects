...
function PlayState:update(dt)
    ...
    if self.canInput then
		...
		if self.mouse:isHover(self.board) then
			self.boardHighlightX, self.boardHighlightY = self.mouse:hover(self.board)
		end

        -- if we've pressed enter, to select or deselect a tile...
        if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') or self.mouse:firstClick() then
